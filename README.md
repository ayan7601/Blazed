# Blazed
<p align="center">
  <img src="https://ayan7601.dev/Blazedlogo.png" alt="Blazed Addon Banner" width="300"/>
</p>

<p align="center">
  <a href="https://github.com/ayan7601/Blazed/releases"><img src="https://img.shields.io/github/downloads/ayan7601/Blazed/total.svg?style=for-the-badge&label=Downloads" alt="Downloads"/></a>
  <img src="https://img.shields.io/github/stars/ayan7601/Blazed?style=for-the-badge" alt="Stars"/>
  <img src="https://img.shields.io/github/repo-size/ayan7601/Blazed?style=for-the-badge" alt="Repo Size"/>
...
<details>
  <summary><strong>⬛Why do I get a disclaimer screen on Multiplayer?</strong></summary>
  <p>
    That's ExploitPreventer, the anti-exploit mod bundled inside Blazed. Tick the box once and it never comes back.
  </p>
</details>
...
4. 🧶**Download Fabric API**
   From: https://modrinth.com/mod/fabric-api (required — Blazed bundles ExploitPreventer, which needs it)

5. 🧩**Put Meteor Client, Baritone, Fabric API and this addon in `.minecraft/mods`**
    - Locate your `.minecraft` folder (type `%appdata%` on Windows search)
    - Drop the `.jar` files inside `/mods`
