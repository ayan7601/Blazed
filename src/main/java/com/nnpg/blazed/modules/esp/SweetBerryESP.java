package com.nnpg.blazed.modules.esp;
...
public class SweetBerryESP extends Module {
    ...
    public SweetBerryESP() {
        super(BlazedAddon.esp, "sweet-berry-esp", "ESP for sweet berry bushes at specific growth ages with threading and tracer support.");
    }
