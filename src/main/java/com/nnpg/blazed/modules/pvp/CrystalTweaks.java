package com.nnpg.blazed.modules.pvp;
...
public class CrystalTweaks extends Module {
    ...
    public CrystalTweaks() {
        super(BlazedAddon.pvp, "crystal-tweaks", "Crystal PvP inventory & combat safety toolkit. Prevents accidental drops, misclicks, interrupted inputs and inventory mistakes during fights.");
    }
