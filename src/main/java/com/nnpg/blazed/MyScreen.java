...
public class MyScreen extends WindowScreen {
    ...
    public static void checkVersionOnServerJoin() {
        ...
        MeteorExecutor.execute(() -> {
            try {
                String versionString = Http.get("https://blazedclient.com/versions/normal1.21.4.txt").sendString();
    ...
    private void buildUI() {
        ...
        githubButton.action = () -> {
            Util.getOperatingSystem().open("https://github.com/realnnpg/blazed");
        };
