package com.ayan7601.blazed.mixin;
...
public class MeteorMixinCanceller implements MixinCanceller {
    ...
    static {
        if (METEOR_PRESENT) {
            LOGGER.info("[Blazed Protection] Meteor Client detected - Meteor's key resolution protection will be disabled to avoid detection.");
        }
    }
