...
import com.ayan7601.blazed.utils.hud.AdminBoard;
...
public class AdminHud extends Module {
    ...
    public AdminHud() {
        super(BlazedAddon.CATEGORY, "admin-hud", "Tells you when staff are in tab.");
    }
    ...
    private void onRender2D(Render2DEvent event) {
        ...
        board.render(event.graphics, hudX, hudY, scale);
    }
