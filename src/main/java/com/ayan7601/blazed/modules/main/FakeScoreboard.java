...
import com.ayan7601.blazed.utils.MoneyFmt;
...
public class FakeScoreboard extends Module {
    private static final String OBJECTIVE = "blazed_fakesb";
    private static final String TEAM_PREFIX = "blazed_sb_";
    ...
    public FakeScoreboard() {
        super(BlazedAddon.CATEGORY, "fake-scoreboard", "Replaces the sidebar with your own numbers.");
    }
