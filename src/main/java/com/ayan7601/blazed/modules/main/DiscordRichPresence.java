...
public class DiscordRichPresence extends Module {
    ...
    private final Setting<List<String>> line1Strings = sgLine1.add(new StringListSetting.Builder()
        ...
        .onChanged(value -> recompileLine1())
    ...
    private final Setting<List<String>> line2Strings = sgLine2.add(new StringListSetting.Builder()
        ...
        .onChanged(value -> recompileLine2())
        .renderer(StarscriptTextBoxRenderer.class)
        .build()
    );
    ...
    public DiscordRichPresence() {
        super(BlazedAddon.CATEGORY, "discord-rich-presence", "Displays Blazed as your presence on Discord.");
