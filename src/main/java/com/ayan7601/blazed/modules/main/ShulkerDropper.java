...
import com.ayan7601.blazed.utils.BlazedShop;
...
public class ShulkerDropper extends Module {
    ...
    public ShulkerDropper() {
        super(BlazedAddon.CATEGORY, "shulker-dropper", "Automatically buys shulkers from shop and drops them.");
    }
    ...
    private void onTick(TickEvent.Pre event) {
        ...
        ChestMenu handler = BlazedShop.openContainer();
        ...
        int shulkerSlot = BlazedShop.findItemSlot(handler, Items.SHULKER_BOX);
        ...
        BlazedShop.spamClick(handler, shulkerSlot, clicksPerBuy.get());
        delayCounter = Math.max(1, delay.get());
    ...
    private void dropShulkers(ChestMenu handler) {
        int containerSlots = BlazedShop.containerSlotCount(handler);
