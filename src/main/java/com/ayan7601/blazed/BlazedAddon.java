...
public class BlazedAddon extends MeteorAddon {
    ...
    public static final String VERSION_CHECK_URL = "https://blazedclient.com/versions/normal26.1.2.txt";
    ...
    public void onInitialize() {
        ...
        Modules.get().add(new BlazedFreecam());
    ...
    private static String resolveVersion() {
        return FabricLoader.getInstance().getModContainer("blazed")
